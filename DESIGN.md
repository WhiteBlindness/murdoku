...
colors:
  ...
  site-shell-dark-text: "#FFF1E4"
  site-shell-dark-copy: "#D9CFDB"
  site-shell-dark-muted: "#B2A8BB"
  site-shell-dark-header: "#242437"
  site-shell-dark-gradient: "linear-gradient(148deg, #121A2A 0%, #282238 52%, #171A2B 100%)"
  site-shell-light-text: "#24283B"
  site-shell-light-copy: "#444558"
  site-shell-light-muted: "#626274"
  site-shell-light-header: "#EEEAF0"
  site-shell-light-gradient: "linear-gradient(148deg, #FCF8F0 0%, #EEE8ED 53%, #E0ECE9 100%)"
