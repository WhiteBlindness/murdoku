...
const packs = [
  ...
  ['city-kit-suburban','City Kit (Suburban)','city-kit-suburban_20','kenney_city-kit-suburban_20.zip','https://kenney.nl/assets/city-kit-suburban',[['building-type-a.glb',['suburban'],'structure'],['fence-2x3.glb',['suburban'],'structure'],['driveway-short.glb',['suburban'],'ground'],['path-stones-messy.glb',['suburban'],'path']]],
  ...
  ['holiday-kit','Holiday Kit','holiday-kit','kenney_holiday-kit.zip','https://kenney.nl/assets/holiday-kit',[['cabin-wall.glb',['holiday'],'structure'],['cabin-roof-snow.glb',['holiday'],'structure'],['snowman.glb',['holiday'],'detail']]],
  ['mini-market','Mini Market','mini-market','kenney_mini-market.zip','https://kenney.nl/assets/mini-market',[['shelf-boxes.glb',['market'],'storage'],['freezer.glb',['market'],'storage'],['cash-register.glb',['market'],'detail']]],
...
const prototypes = [
  ['suburban','Casa suburbana',['city-kit-suburban','nature-kit'],['city-kit-suburban--building-type-a','city-kit-suburban--fence-2x3','city-kit-suburban--driveway-short','city-kit-suburban--path-stones-messy','nature-kit--tree-default','nature-kit--plant-bush','nature-kit--path-stone','nature-kit--fence-simple']],
  ...
  ['market','Loja de bairro',['mini-market'],['mini-market--shelf-boxes','mini-market--freezer','mini-market--cash-register']],
  ...
  ['holiday','Cabana sazonal',['holiday-kit'],['holiday-kit--cabin-wall','holiday-kit--cabin-roof-snow','holiday-kit--snowman']],
